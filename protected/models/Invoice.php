...
class Invoice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('invoice_id, account_id, shop_id, customer_id, created_on, created_by, modified_on, modified_by, customer_search', 'safe', 'on'=>'search'),
		);
	}
