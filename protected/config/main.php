...
return array(
	...
	'components'=>array(
        ...
        'ePdf' => array(
            ...
            'params'        => array(
                'mpdf'     => array(
                    'librarySourcePath' => 'application.pdf.mpdf.*',
                    'constants'         => array(
                ...
                'HTML2PDF' => array(
                    'librarySourcePath' => 'application.pdf.html2pdf.*',
                    'classFile'         => 'html2pdf.class.php', // For adding to Yii::$classMap
                    'defaultParams'     => array( // More info: http://wiki.spipu.net/doku.php?id=html2pdf:en:v4:accueil
                        'orientation' => 'P', // landscape or portrait orientation
                        'format'      => 'A4', // format A4, A5, ...
                        'language'    => 'en', // language: fr, en, it ...
                        'unicode'     => false, // TRUE means clustering the input text IS unicode (default = true)
	...
	'params'=>array(
		...
		'adminEmail'=>'oleglutsenko@ukr.net',
	),
);